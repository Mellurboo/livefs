...
#
CFLAGS ?=
COMMON_CFLAGS = -static -Wall -Wextra -pedantic -Werror -Wno-unused-function -Wno-unused-but-set-parameter -Wno-unused-parameter -O2 -D_FILE_OFFSET_BITS=64 -I include -g
